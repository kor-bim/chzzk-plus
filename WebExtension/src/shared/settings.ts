...
export interface Settings {
  ...
  broadcastPreviewEnabled: boolean;
  playbackBarEnabled: boolean;
  vodBroadcastTimeEnabled: boolean;
  vodResumeEnabled: boolean;
...
export const DEFAULT_SETTINGS: Readonly<Settings> = Object.freeze({
  ...
  broadcastPreviewEnabled: true,
  playbackBarEnabled: true,
  vodBroadcastTimeEnabled: true,
  vodResumeEnabled: true,
